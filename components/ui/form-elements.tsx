...
>(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={cn(
      "rounded-3xl border border-border bg-card text-card-foreground shadow-sm glass-panel",
      className
    )}
    {...props}
  />
...
export { Input, Label, Card, CardHeader, CardFooter, CardTitle, CardDescription, CardContent };
